...
optionsEls.keywordHintsEnabled.addEventListener('change',async()=>{const enabled=optionsEls.keywordHintsEnabled.checked;try{await optionsPatchAutomation({keywordHints:{...optionsAutomation.automation.keywordHints,enabled}},enabled?'文档类网站提示已开启':'文档类网站提示已关闭');}catch(error){optionsShowError(error);optionsRenderAutomation();}});
